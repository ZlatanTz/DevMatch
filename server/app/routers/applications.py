...
async def update_application(application_id: int, update: schemas.ApplicationUpdate, db: AsyncSession = Depends(get_db), current_user = Depends(require_roles("candidate"))):
