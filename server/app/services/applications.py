...
async def create_application(
  ...
  job_id: int):
    ...
    dup_stmt = select(models.Application).where(
        and_(
            models.Application.job_id == job_id,
            models.Application.candidate_id == application_data.candidate_id
        )
    )
    ...
    db_app = models.Application(**application_data.model_dump(), job_id=job_id)
    db.add(db_app)
    await db.commit()
